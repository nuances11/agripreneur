		...
		<div class="col-md-6">
			<div class="panel">
				...
				<div class="panel-body">
					<form class="form-horizontal" id="add_sub_category">
                    <input type="hidden" name="action_url" id="action_url" value="<?php echo base_url();?>admin/subcategory/save">
                    <input type="hidden" name="base_url" id="base_url" value="<?php echo base_url();?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="subcategory_identifier" name="subcategory_identifier">
							</div>
						</div>
						<div class="form-group">
