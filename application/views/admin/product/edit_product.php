					...
					<div class="panel-body">
						...
						<form class="form-horizontal" id="admin_edit_product" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="threshold" name="threshold" value="<?php echo $product->threshold;?>">
								</div>
							</div>
							<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="product_availability" name="product_availability" value="<?php echo date('m/d/Y h:i A', strtotime($product->availability_start)) . ' - ' . date('m/d/Y h:i A', strtotime($product->availability_end)) ;?>">
                                </div>
                            </div>
                            <div class="form-group">
