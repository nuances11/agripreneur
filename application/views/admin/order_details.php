                            ...
                            <div class="col-sm-6 right-side text-right">
                                <?php
                                    if ($transaction->transaction_status == 0) {
                                        ?>
                                        <button type="button" class="btn btn-success" id="accept_order" data-id="<?php echo $transaction->transaction_id ;?>" data-url="<?php echo base_url();?>"> Accept Order</button>
                                        <button type="button" class="btn btn-warning" id="cancel_order"  data-id="<?php echo $transaction->transaction_id ;?>" data-url="<?php echo base_url();?>"> Cancel Order</button>
                                        <?php
