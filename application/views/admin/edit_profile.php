<div class="row page-title-div">
	...
	<div class="col-md-6 right-side">
        <a href="<?php echo base_url();?>admin/users" class="btn bg-black" role="button">Back</a>
	</div>
	<!-- /.col-md-6 text-right -->
</div>
<!-- /.row -->
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" id="admin_update_user" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
    							...
    							<div class="col-sm-3">
                                    <select class="form-control" name="status" id="status">
                                        ...
                                        <option value="2" <?php if($user->status == '0'){ echo 'selected'; }?>>Inactive</option>
                                    </select>
    							</div>
    						</div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10">
									<a href="<?php echo base_url();?>admin/user/<?php echo $user->id;?>/change-password" class="btn bg-black"> <i class="fa fa-lock"></i>Change Password</a>
								</div>
                            </div>
