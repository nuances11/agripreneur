									...
									foreach ($orders as $order) {
										?>
									 		<tr>
                                                ...
                                                <td>
                                                    <?php
                                                        $php_timestamp_date = date("d F Y H:i:s", strtotime($order->timestamp_created));
												...
												<td>
                                                    <a class="btn btn-default" href="<?php echo base_url();?>admin/view/order/<?php echo $order->transaction_id;?>"><i class="fa fa-eye"></i>View Order</a>
                                                </td>
											</tr>
										<?php
									}
